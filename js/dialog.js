...
(function(root, factory) {
	...
	var Dialog = function() {
		...
		this.id = 'dialog_' + rnd;
		this.settings = {};
		this.settings.closeTpl = $('<span class="ui-dialog-close js-dialog-close"></span>');
	...
	Dialog.prototype = {
		...
		bindEvent: function() {
			...
			$(this.dialogContainer).on('click', '.js-dialog-close', function() {
				$(".ui-dialog").animate({bottom:"-100%",display:"none"},400);
				setTimeout(function(){
					$(".ui-dialog").remove();
				},400);
				$(".popBack").fadeOut(400);
		...
		setPosition: function() {
			if (this.showed) {
				...
				_this.dialogContainer.animate({bottom:0},400)
			}
		}
	}
	return Dialog;
